...
$tb_kamarpakai            = "SELECT * FROM tb_kamarpakai WHERE id_kamarpakai='$id_kamarpakai'";
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-2 d-flex align-items-center">
              <h5 class="col-lg-7 col-7">Edit Data Kamar Pakai</h5>
            </div>
            <div class="card-body px-4 pt-2 pb-2">
              <form action="update_kamarpakai.php" method="post">
                <div class="form-row d-flex">
                  <div class="form-group col-md-6 mx-1">
                    <label for="id_kamarpakai">ID Kamar Pakai</label>
                    <div class="mb-3">
                      <input type="text" class="form-control" name="id_kamarpakai" value="<?php echo $rows['id_kamarpakai']; ?>" readonly> 
                    </div>
                  </div>
                  <div class="form-group col-md-6 mx-1">
                    <label for="id_pasien">ID Pasien</label>
                    <input type="text" class="form-control" name="id_pasien" value="<?php echo $rows['id_pasien']; ?>" readonly>
                  </div>
                </div>
                <div class="form-row d-flex">
                  <div class="form-group col-md-6 mx-1">
                    <label for="id_kamar">ID Kamar</label>
                    <input type="text" class="form-control" name="id_kamar" value="<?php echo $rows['id_kamar']; ?>" readonly>
                  </div>
                  <div class="form-group col-md-6 mx-1">
                    <label for="lama_pakai">Lama Pemakaian</label>
                    <input type="text" class="form-control" name="lama_pakai" value="<?php echo $rows['lama_pakai']; ?>">
